...
| ORD-022 | P2 | Respaldos | Restauración sin **respaldo preventivo automático**; ventana DataStore↔Room no cubre muerte del proceso | `backup/BackupManager.kt:142-148,193-201`; `ui/screens/SettingsScreen.kt:136-152` | Pérdida de datos actuales ante fallo en ventana crítica | Exportación preventiva automática + journal | CORREGIDO — `OrdiaViewModel.importBackup` exporta un journal `ordia_pre_restore_backup.json` en almacenamiento privado antes de reemplazar datos y avisa en la UI |
