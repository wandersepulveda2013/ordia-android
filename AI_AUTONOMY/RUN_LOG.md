...
- **Hallazgos adicionales (descubrimiento continuo)**: c.178 ya registró **"último viernes del mes" → fecha errónea** (P2, rama `lastWeekday` del parser) como próxima prioridad — confirmado, queda pendiente para un próximo run (ortogonal a este fix de duración).
