...
- **HEAD inicial**: `1f6c04d`. **HEAD final**: (a registrar tras commit + push; rebase no destructivo sobre `5b01c98` reescribió mi commit a `223fef4` antes del ajuste de docs final).
