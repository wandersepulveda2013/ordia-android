...
- **HEAD inicial**: `1f6c04d`. **HEAD final**: (a registrar tras commit + push).
- **Estado**: FIXED → VERIFIED (dominio JVM: 1148 tests, 0 failures; smoke 25 OK).
