...
- **OPEN pendientes** (mayor impacto primero):
  ...
  - P3 residuos de título restantes ("a las 3.5" decimal-hour). (El residuo "el primer" suelto de cadencia precedente quedó RESUELTO c.269; el residuo "cada \<unidad>" intervalo-1 quedó RESUELTO c.269; el "de \<mes>" de límites mensuales quedó RESUELTO c.265.)
