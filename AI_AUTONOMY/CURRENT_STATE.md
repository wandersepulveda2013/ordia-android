...
- **Fecha/hora (UTC)**: 2026-09-07 23:15:44 UTC
...
- **Prevención de notas vacías**: Se modificó `NotepadViewModel` para descartar nuevas notas vacías y eliminar las existentes si se vacían completamente su título y contenido.
- **Auto-focus**: Se añadió `FocusRequester` en `NoteEditorScreen` para poner el foco automáticamente en el título al crear una nueva nota, reduciendo la fricción.
- **Tests**: Se añadió `NotepadViewModelTest` para verificar el comportamiento de guardar/descartar notas.
