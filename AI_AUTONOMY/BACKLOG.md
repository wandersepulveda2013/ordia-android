...
| P3 | Parser | Residuos de título no limpiados: "a primera hora" (sin interpretar/limpiar); "que viene" tras fecha ("el viernes que viene"); "del" huérfano ("a las 3pm del jueves"); rango horario "de 18 a 20" no parseado | probe JVM ciclo 7 | ABIERTO (candidato a ciclo 8) |
