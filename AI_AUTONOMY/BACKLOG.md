...
| P2 | QA | Verificar que las 6 variantes (Safe/Full/Advanced × debug/release) compilan tras cambios | `./gradlew test` | VERIFIED |
...
| PRIORIDAD | ÁREA | PROBLEMA | EVIDENCIA | ESTADO |
|-----------|------|----------|----------|--------|
| P2 | Backup | Comprobar restauración con manifiesto corrupto (escenario adverso) | Pruebas adversariales demuestran resiliencia | VERIFIED |
