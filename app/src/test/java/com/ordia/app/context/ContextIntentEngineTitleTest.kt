...
class ContextIntentEngineTitleTest {
    ...
    fun studyStripsDateAndTimeResidueAndFixesCapitalization() {
        ...
        // descarta. c.717 corrige el robo del bono específico de REMINDER
        // (+0.25) que, sumado a la pista temporal (+0.1), vencía al piso de
        // TASK (0.45) en textos con fecha: el envolvente gobierna en TASK.
