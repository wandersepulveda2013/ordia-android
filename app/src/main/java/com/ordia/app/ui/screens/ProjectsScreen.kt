...
fun ProjectsScreen(
    ...
    LazyColumn(
        ...
        if (state.projects.isEmpty()) {
            item { EmptyState("Todavía no hay proyectos", "Un proyecto agrupa tareas orientadas a un objetivo común. Crea uno cuando tengas un conjunto de tareas relacionadas.", "Crear proyecto", onAction = { adding = true }) }
        } else {
