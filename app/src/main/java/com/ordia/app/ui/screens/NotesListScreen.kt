            ...
            if (notes.isEmpty()) {
                ...
                LazyColumn(
                    ...
                    contentPadding = PaddingValues(
                        horizontal = NotepadTheme.spacing.edge,
                        vertical = NotepadTheme.spacing.medium
                    ),
                ) {
    ...
    Box(
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            Text(
                ...
                modifier = Modifier.padding(top = NotepadTheme.spacing.small),
            )
        }
    }
}
...
private fun NoteRow(
    ...
    OrdiaCard(
        modifier = Modifier
            .fillMaxWidth()
            .padding(vertical = NotepadTheme.spacing.small),
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                if (preview.isNotBlank()) {
                    Text(
                        ...
                        maxLines = 2,
                        overflow = TextOverflow.Ellipsis,
                        modifier = Modifier.padding(top = if (note.title.isNotBlank()) NotepadTheme.spacing.extraSmall else 0.dp),
                    )
                }
                Text(
                    date,
