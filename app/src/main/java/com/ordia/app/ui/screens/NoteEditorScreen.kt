...
fun NoteEditorScreen(
    ...
    LaunchedEffect(note?.id) {
        if (note != null) {
            ...
            // Auto-focus title if creating a new note to reduce friction
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                title = { Text(if (note == null) "Nueva nota" else "Editar", style = MaterialTheme.typography.titleMedium) },
                actions = {
                    Text(
                        "Hecho",
        ...
        Column(
            modifier = Modifier
                ...
                .padding(horizontal = spacing.contentPadding, vertical = spacing.medium),
