...
// Semantic Colors
val SemanticAlert = Color(0xFFD64E4E)
val SemanticSuccess = Color(0xFF4A8B56)
val SemanticFocus = Color(0xFF4A7C99)
val SemanticAutomation = Color(0xFF8A682D) // Reusing OrdiaGold as a base for automation
