...
val OrdiaLightGray = Color(0xFFF5F5F5)
val OrdiaDarkGray = Color(0xFF2E2E2E)
...
private val DarkColors = darkColorScheme(
    primary = OrdiaWhite,
    onPrimary = OrdiaInk,
    primaryContainer = OrdiaDarkGray,
