...
- ORD-029 (i18n en Kotlin) parcial: los 4 archivos citados por la auditoría quedan localizados (65 strings nuevos: QuickCaptureActivity, GuardianOverlayService, Navigation rail, OrdiaUpdateManager con razones de actualización visibles al usuario); el hallazgo sigue ABIERTO por literales en otras pantallas/servicios.
