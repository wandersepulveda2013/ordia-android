...
- ORD-029 (i18n en Kotlin) parcial: localizados los 4 archivos citados por la auditoría (65 strings) y además todos los literales visibles de pantallas Compose, componentes y servicios (~300 strings en 6 archivos de recursos nuevos); el hallazgo sigue ABIERTO hasta ejecutar lint final y revisión visual.
