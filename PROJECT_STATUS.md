...
- Hallazgos críticos de la auditoría: **3/3 P0 corregidos, 8/8 P1 corregidos, 12/12 P2 corregidos**; 2 bloqueos por CI documentados (ORD-015 migración Room, ORD-032 FTS) y 1 abierto (P3) sin impacto en la línea base.
...
- ORD-029 (i18n en Kotlin) avanzado: localizados los 4 archivos citados por la auditoría (65 strings), todos los literales visibles de pantallas Compose, componentes y servicios (~300 strings en 6 archivos de recursos nuevos) y, en 1b6f8d0, los últimos literales residuales (NotesScreen, NoteEditorScreen, FocusScreen, HabitsScreen, PlannerScreen, SettingsScreen) con 14 claves muertas eliminadas. **Lint final `previewAdvancedDebug`: 0 errores / 0 `UnusedResources`**; regresión 1278 tests, 0 fallos; APK regenerado y verificado. Resto documentado como limitación por diseño: etiquetas de los 15 destinos de `Navigation.kt` y del guardián usan `label()` de dominio (no R.string).
